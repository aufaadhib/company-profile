import type { CmsArticleStatus } from "@/lib/cms-service";

const statusCopy: Record<CmsArticleStatus, { label: string; className: string }> = {
...
export function AdminStatus({ status }: { status: CmsArticleStatus }) {
